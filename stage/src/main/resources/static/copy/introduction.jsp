		...
		//</div>
			...
			var ul = $("<ul></ul>");
			 for(var i = 0 ;i< 4 ; i++ ){
				 var li = $("<li></li>");
				   if(i==0)
					  li.addClass("sku-line selected").append("你好").append("<i></i>");
				  else
					  li.addClass("sku-line").append("你好").append("<i></i>"); 
				  ul.append(li);
			 }  
			   console.log(ul);  
			 div_c8.append(ul);    */ 
	...
	<div class="item-inform">
		...
		<div class="clearfixRight">
			...
			<div class="tb-detail-hd">
				<h1 id="c1">良品铺子 手剥松子218g 坚果炒货 巴西松子</h1>
			</div>
			<div class="tb-detail-list">
				...
				<div class="tb-detail-price">
					<li class="price iteminfo_price">
						<dt>促销价</dt>
						<dd>
							<em>¥</em><b id="c3" class="sys_item_price">56.90</b>
						</dd>
					</li>
					<li class="price iteminfo_mktprice">
						<dt>原价</dt>
						<dd>
							<em>¥</em><b id="c4" class="sys_item_mktprice">98.00</b>
						</dd>
					</li>
					<div class="clear"></div>
				</div>
	...
	<select class="dist" disabled="disabled" ></select> 
				...
				<ul class="tm-ind-panel">
					<li class="tm-ind-item tm-ind-sellCount canClick">
						<div class="tm-indcon">
							<span  class="tm-label">月销量</span><span id="c5" class="tm-count">1015</span>
						</div>
					</li>
					<li class="tm-ind-item tm-ind-sumCount canClick">
						<div class="tm-indcon">
							<span   class="tm-label">累计销量</span><span id="c6" class="tm-count">6015</span>
						</div>
					</li>
					<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
						<div class="tm-indcon">
							<span  class="tm-label">累计评价</span><span id="c7" class="tm-count">640</span>
						</div>
					</li>
				</ul>
				<div class="clear"></div>
					...
					<div class="am-tab-panel am-fade am-in am-active">
						...
						<div class="details">
							...
							<div class="twlistNews">
								<img src="../images/tw1.jpg" /> <img src="../images/tw2.jpg" />
								<img src="../images/tw3.jpg" /> <img src="../images/tw4.jpg" />
								<img src="../images/tw5.jpg" /> <img src="../images/tw6.jpg" />
						...
						<ul class="am-comments-list am-comments-list-flip">
							<li class="am-comment">
								<!-- 评论容器 --> <a href=""> <img class="am-comment-avatar"
									src="../images/hwbn40x40.jpg" /> <!-- 评论者头像 -->
							</a>
