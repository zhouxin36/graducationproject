...
<script type="text/javascript">
	...
	$(function () {
														...
														.mouseover(
																function() {
																	$(this)
																			.attr(
																					"class",
																					"appliance js_toggle relative hover");
																	$(this)
																			.children(
																					".top")
																			.attr(
														...
														.mouseover(
																function() {
																	...
																	$(b)
																			.attr(
																					"style",
																					"width: 1519px; float: left; display: block;");
																});
												$(this).mouseout(
														function() {
															t = setTimeout(
		...
		function show_p(/* msg, */p) {
			...
			h1_1.append("甜品");
			h1_2.append("每一道甜品都有一个故事");
			div1_1.append(h1_1).append(h1_2).append(div1_2).append(sp);
			div1.append(div1_1);
			p.append(div1);
			...
			for (var i = 0; i < 6; i++) {
				var a2_1_1 = $("<a></a>");
				a2_1_1.addClass("outer").attr("href", "#");
		...
		function carousel() {
			...
			for (var i = 0; i < 10; i++) {
				...
				var img = $("<img/>");
				img.attr("src", "../images/ad" + (i % 8 + 1) + ".jpg");
				var div_dot = $("<div></div>");
				div_dot.text("●");
				var left = 400 + i * 20;
